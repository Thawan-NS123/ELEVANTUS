...
UPDATE tb_cliente 
   SET  id_personal			 		= 1, 
        ...
        ds_plano 					= 'Premium', 
        ds_cpf						= '546.643.643-34',
        ds_genero 					= 'Masculino', 
        dt_nascimento 				= '2004-09-23', 
        nr_altura 					= 1.90, 
        nr_peso 					= 80.00, 
        nr_telefone 				= '4002-8922',
        ds_objetivo 				= 'Fazer parte do samba',
        ds_observacao 				= 'Perna arrumada', 
        ds_treino_da_semana 		= 'Tambor',
        ds_dia_da_semana 			= 'Dias úteis',
        hr_horario 					= '14:00'
 WHERE id_cliente 					= 1;
